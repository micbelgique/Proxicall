...
namespace ProxiCall
{
    ...
    /// </summary>
    public class ProxiCallAccessors
    {
        /// <summary>
        ...
        public ProxiCallAccessors(ConversationState conversationState = null, UserState userState = null)
        {
        ...
        /// <summary>
        /// Gets the <see cref="IStatePropertyAccessor{T}"/> name used for the <see cref="BotState"/> accessor.
        /// </summary>
        /// <remarks>Accessors require a unique name.</remarks>
        /// <value>The accessor name for the counter accessor.</value>
        public static string CounterStateName { get; } = $"{nameof(ProxiCallAccessors)}.CounterState";
        ...
        /// </value>
        public IStatePropertyAccessor<ProxiCallState> BotState { get; set; }
